...

{
  ...
  "kind": "changelog",         // changelog | spec | webhook | rss | custom
  "url": "https://stripe.com/docs/changelog",
  "selector": "#content",      // optional CSS selector
  "poll_interval_minutes": 60  // optional, default 60
}
```

**Response (201):**
```json
{ "source": { "id": 1, "name": "Stripe API Changelog", "kind": "changelog", "url": "...", "status": "active", ... } }
```
...
{
  "diff": {
    "id": 1, "source_id": 1, "added_lines": 5, "removed_lines": 2,
    "severity": "warning", "summary_text": "🟡 Notable change: +5 lines added, -2 lines removed",
    "diff_patch": "...", "detected_at": "2026-08-25T12:00:00Z"
  },
  "source": { "name": "Stripe API Changelog", "url": "..." }
}
```
...
{
  "channel": "webhook",      // webhook | slack | email | in_app
  "target": "https://your-server.com/webhook",
  "source_id": 1,            // optional, null = all sources
  "config": {}               // optional channel-specific config
}
```
...
```json
{
  ...
  "source": { "id": 1, "name": "Stripe API Changelog" },
  "diff": {
    "id": 42,
    "severity": "breaking",
    "added_lines": 3,
...
{
  "plans": [
    { "key": "free", "name": "Free", "price_monthly": 0, "price_monthly_dollars": "0.00", "max_sources": 2, ... },
    { "key": "starter", "name": "Starter", "price_monthly": 3900, "price_monthly_dollars": "39.00", ... }
  ]
}
```
...
**Response (200):**
```json
{ "status": "ok", "app": "API Changelog Radar", "version": "1.0.0", "timestamp": "..." }
```
